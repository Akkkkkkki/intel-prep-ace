...
async function generateInterviewQuestions(
  ...
  if (cvAnalysis) {
    ...
    questionContext += `Experience: ${cvAnalysis.experience_years} years\n`;
...
Focus on:
1. Questions that align with the company's interview philosophy and culture
2. Questions that test for the specific skills and experience required
3. Questions that are appropriate for the interview stage
4. Questions that leverage actual interview experiences from reviews
5. Questions that are personalized to the candidate's background
